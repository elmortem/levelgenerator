...
{
	[Obsolete("Use GameObjectsNode instead")]
	public class OldGameObjectsNode : PreviewNode
	{
		[Input] public List<VectorData> Vectors;
		public bool Enabled = true;
		[Output] public List<OldGameObjectInstanceData> Results = new();
		
		public GameObject Prefab;

		private List<OldGameObjectInstanceData> _results;
		...
		private void CalcResults(bool force = false)
		{
			...
			{
				_results.Add(new OldGameObjectInstanceData { Prefab = Prefab, Vector = vectors[i] });
			}
		}
	}
}